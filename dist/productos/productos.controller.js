...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Crear un nuevo producto (requiere idCategoria existente)' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar todos los productos (incluye su categoría)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de productos con categoría', type: [producto_entity_1.Producto] }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener un producto por ID (incluye su categoría)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del producto', type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Producto encontrado con su categoría', type: producto_entity_1.Producto }),
