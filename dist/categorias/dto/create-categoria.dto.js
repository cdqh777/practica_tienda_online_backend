...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Electrónica', description: 'Nombre de la categoría' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateCategoriaDto.prototype, "nombre", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Dispositivos electrónicos y accesorios', description: 'Descripción de la categoría' }),
    (0, class_validator_1.IsString)(),
