...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener una categoría por ID (incluye sus productos)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID de la categoría', type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Categoría encontrada con sus productos', type: categoria_entity_1.Categoria }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID de la categoría', type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Categoría eliminada correctamente' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Categoría no encontrada' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
