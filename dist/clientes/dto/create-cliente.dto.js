...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Juan Carlos', description: 'Nombres del cliente' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'juan.garcia@email.com', description: 'Correo electrónico único' }),
