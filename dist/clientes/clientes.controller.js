...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Cliente creado exitosamente', type: cliente_entity_1.Cliente }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de clientes', type: [cliente_entity_1.Cliente] }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener un cliente por ID (incluye sus órdenes)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del cliente', type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Cliente encontrado', type: cliente_entity_1.Cliente }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del cliente', type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Cliente actualizado', type: cliente_entity_1.Cliente }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Cliente no encontrado' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Datos de entrada inválidos' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar un cliente (soft delete)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID del cliente', type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Cliente eliminado correctamente' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Cliente no encontrado' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
